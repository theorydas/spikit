...
class Force(ABC):
    ...
    @abstractmethod
    def F(self, r2: float, u: float) -> float:
         pass
    
    def dE_dt(self, r2: float, u: float) -> float:
        """ Returns the rate of change of the orbital energy [J/s] due to the force. """
        return self.F(r2, u) *u # [J/s]
    
    def dlnL_dt(self, r2: float, u: float) -> float:
    ...
    def dL_dt(self, r2: float, u: float, a: float, e: float) -> float:
...
class Accretion(Force):
    ...
    # ====================
    def dm2_dt(self, r2: float, u: float) -> float:
